...
// PrettyLogFormatter for logrus
type PrettyLogFormatter struct {
...
func (f *PrettyLogFormatter) Format(entry *logrus.Entry) ([]byte, error) {
...
func (f *PrettyLogFormatter) appendKeyValue(b *bytes.Buffer, key, value interface{}) {
	switch value.(type) {
	case string:
